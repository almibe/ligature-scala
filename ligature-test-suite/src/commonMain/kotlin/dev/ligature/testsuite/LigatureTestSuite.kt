    ...
    test("matching statements in datasets") {
      runTest { ligature ->
        ...
        ligature.write(testDataset) { tx ->
          ...
          tx.addStatement(Statement(entity3, b, StringLiteral("Hello")))
        }
        ligature.query(testDataset) { tx ->
          tx.matchStatements().toSet() shouldBe
              setOf(
          ...
          tx.matchStatements(null, a).toSet() shouldBe
              setOf(
                  Statement(entity1, a, StringLiteral("Hello")),
                  Statement(entity2, a, entity1),
                  Statement(entity2, a, entity3))

          tx.matchStatements(null, null, StringLiteral("Hello")).toSet() shouldBe
              setOf(
                  Statement(entity1, a, StringLiteral("Hello")),
                  Statement(entity3, b, StringLiteral("Hello")))

          tx.matchStatements(null, a, StringLiteral("Hello")).toSet() shouldBe
              setOf(Statement(entity1, a, StringLiteral("Hello")))
        }
      }
    }
