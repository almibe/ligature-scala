...
class ParserSpec : FunSpec() {
  ...
  init {
    test("parse a boolean literal") {
      runCases(mapOf("true" to listOf(Element.BooleanLiteral(true))))
    }
    ...
    test("Ligature value parsing") {
      runCases(
          mapOf(
              ...
              "<https://ligature.dev>" to
                  listOf(Element.IdentifierLiteral(Identifier("https://ligature.dev"))),
              // TODO add this case back in
              // "0x1233" to listOf(LigatureValue(BytesLiteral(byteArrayOf(0x12.toByte(),
              // 0x33.toByte()))))
              ))
    }
      ...
      runCases(
          mapOf(
              ...
              "{ let x = 5 }" to
                  listOf(
                      Element.Scope(
                          listOf((Element.LetStatement("x", Element.IntegerLiteral(5))))))))
    }
    ...
    test("parse if expressions") {
      runCases(
          mapOf(
              "if {} {}" to
                  listOf(
                      Element.IfExpression(
                          Element.Conditional(Element.Scope(listOf()), Element.Scope(listOf())))),
              "if { -123123 } true" to
                  listOf(
                      Element.IfExpression(
                          Element.Conditional(
                              Element.Scope(listOf(Element.IntegerLiteral(-123123))),
                              Element.BooleanLiteral(true)))),
              "if {{ true }} false" to
                  listOf(
                      Element.IfExpression(
                          Element.Conditional(
                              Element.Scope(
                                  listOf(Element.Scope(listOf(Element.BooleanLiteral(true))))),
              ...
              "if true false elsif false true else 7" to
                  listOf(
                      Element.IfExpression(
                          Element.Conditional(
                              Element.BooleanLiteral(true), Element.BooleanLiteral(false)),
                          listOf(
                              Element.Conditional(
                                  Element.BooleanLiteral(false), Element.BooleanLiteral(true))),
                          Element.IntegerLiteral(7))),
              // note: the following test is a little weird since it should parse correctly but
              // would be a runtime
              // error
              "if 1 2 elsif 2 3 elsif 3 4 else 5" to
                  listOf(
                      Element.IfExpression(
                          Element.Conditional(Element.IntegerLiteral(1), Element.IntegerLiteral(2)),
                          listOf(
                              Element.Conditional(
                                  Element.IntegerLiteral(2), Element.IntegerLiteral(3)),
                              Element.Conditional(
                                  Element.IntegerLiteral(3), Element.IntegerLiteral(4))),
              ...
              "let x = foo(6)" to
                  listOf(
                      Element.LetStatement(
                          "x", Element.FunctionCall("foo", listOf(Element.IntegerLiteral(6))))),
              "let x = { foo(\"hello\") }" to
                  listOf(
                      Element.LetStatement(
                          "x",
                          Element.Scope(
                              listOf(
                                  Element.FunctionCall(
                                      "foo", listOf(Element.StringLiteral("hello")))))))))
    }
                      ...
                      Element.LambdaDefinition(
                          ...
                          listOf(
                              Element.FunctionCall(
                                  "foo2",
                                  listOf(
                                      Element.Name("z"), Element.Name("y"), Element.Name("x"))))))))
    }
      ...
      runCases(
          mapOf(
              ...
              "6.add(7)" to
                  listOf(
                      Element.FunctionCall(
                          "add", listOf(Element.IntegerLiteral(6), Element.IntegerLiteral(7)))),
              "6.add(7).subtract(13).add(5)" to
                  listOf( // add(subtract(add(6 7) 13) 5)
                      Element.FunctionCall(
                          "add",
                          listOf(
                              Element.FunctionCall(
