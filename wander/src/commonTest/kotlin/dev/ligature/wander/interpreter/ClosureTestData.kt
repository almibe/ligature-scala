    ...
    listOf(
            ...
            result =
                Right(
                    Element.IdentifierLiteral(
                        Identifier.create("testEntity").getOrElse {
        ...
        TestInstance(
            ...
            script =
               ...
               |  value2
               |}
               |second(<testEntity> "hello")"""
                    .trimMargin(),
            result = Right(Element.StringLiteral("hello"))),
        TestInstance(
            description = "function3 def",
            script =
                """let middle = { value1 value2 value3 ->
               |  value2
               |}
               |middle(<testEntity> "hello" 24601)"""
                    .trimMargin(),
            result = Right(Element.StringLiteral("hello"))),
        TestInstance(
        ...
        TestInstance(
            ...
            script =
                """let middle = {x y z -> y}
               |24601.middle("hello" <world>).middle(1 2).middle(6 7)"""
                    .trimMargin(),
